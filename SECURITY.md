...
1. **Email:** Send an email to [omega-mvc](mailto:agisoftt@gmail.com). Please provide a detailed description of the vulnerability.

2. **GitHub Security Advisories:** If you prefer, you can use GitHub's security advisory features. Create a new security advisory directly on the [Security tab](https://github.com/omega-mvc/serializable-closure/security) of this repository.
